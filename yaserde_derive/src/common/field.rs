  ...
  fn from(path: &syn::Path) -> Self {
    let result = if let Some(segment) = path.segments.last() {
      match segment.ident.to_string().as_str() {
        ...
        "i8" | "Int8" => Some(Field::FieldI8),
        "u8" | "Uint8" => Some(Field::FieldU8),
        "i16" | "Int16" => Some(Field::FieldI16),
        "u16" | "Uint16" => Some(Field::FieldU16),
        "i32" | "Int32" => Some(Field::FieldI32),
        "u32" | "Uint32" => Some(Field::FieldU32),
        "i64" | "Int64" => Some(Field::FieldI64),
        "u64" | "Uint64" => Some(Field::FieldU64),
